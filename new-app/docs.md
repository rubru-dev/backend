...
- **RubahrumahxGolden > Kalender Survey > PDF Laporan:** Blok tanda tangan laporan diposisikan di pojok kanan, memakai lokasi tetap `Bekasi`; setelah `Hormat Kami` ditambahkan logo Rubru Pest dari header dengan ukuran lebih besar dan jarak rapat ke `Rubrupest Manajemen`.
...
- **Penawaran > Penawaran Golden:** Tambah field `Jenis Treatment` dengan opsi `Pra-Konstruksi` dan `Pasca-Konstruksi`; nilai tampil sebagai baris baru di tabel preview/PDF penawaran Golden dan ikut tersimpan di list penawaran lokal.
- **Style Semua Penawaran:** Preview dokumen memakai font 12px; judul utama penawaran memakai font 14px. Area halaman memakai padding atas/bawah `0.5cm` dan padding kiri/kanan `1.5cm`; blok tanda tangan RO tetap di sisi kanan bawah seperti sebelumnya dan sekarang menampilkan logo sesuai header dengan ukuran lebih besar (`/images/logo.png`, `/images/offer-logos/rkr-logo.jpeg`, `/images/offer-logos/rubru-pest-logo.jpeg`).
...
- **Style Semua Penawaran:** Jarak antara logo tanda tangan dan nama RO/Relation Officer diperkecil; isi dokumen memakai padding kiri/kanan `1.5cm`, sementara blok tanda tangan dibuat keluar dari padding tersebut agar logo dan nama RO tetap sejajar kanan seperti margin 0.
...
- **PDF Penawaran:** Print window memakai `@page { size: A4 portrait; margin: 0; }`, `.offer-page` width `210mm`, min-height `297mm`, padding atas/bawah `0.5cm`, padding kiri/kanan `1.5cm`, dan `print-color-adjust: exact`.
