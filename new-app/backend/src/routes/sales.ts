...
router.get("/kanban", async (req: Request, res: Response) => {
  ...
  // Auto-carryover DIMATIKAN: dulu menyalin ulang Outstanding bulan lalu setiap load,
  // sehingga card yang DIHAPUS muncul lagi saat refresh. Carry-over kini hanya manual
  // lewat tombol "Carryover dari bulan lalu" (POST /kanban/carryover).
