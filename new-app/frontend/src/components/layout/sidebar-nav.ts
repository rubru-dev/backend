...
export const NAV_GROUPS: NavGroup[] = [
  ...
  // Group: telemarketing.view | Items: telemarketing.kanban, telemarketing.follow_up, telemarketing.kalender, telemarketing.laporan_harian
  {
    ...
    roles: ["Telemarketing"],
    items: [
      { label: "Kanban Admin RKR",                 href: "/telemarketing/kanban",                      icon: "Kanban",       permission: "telemarketing.kanban" },
      { label: "Kanban Admin Golden",              href: "/telemarketing/kanban-golden",               icon: "Kanban",       permission: "telemarketing.kanban" },
      { label: "Kanban Admin Filter Air",          href: "/telemarketing/kanban-filter-air",           icon: "Kanban",       permission: "telemarketing.kanban" },
      ...
      { label: "Kalender After AP Golden",         href: "/telemarketing/kalender-after-golden",       icon: "Hammer",       permission: "telemarketing.kalender" },
  ...
  // Group: projek_sipil.view | Items: projek_sipil.view, projek_interior.view, pic.kalender_visit, pic.dokumentasi
  {
    ...
    items: [
      ...
      { label: "Upload Dokumentasi Projek", href: "/pic/dokumentasi",    icon: "Images",       permission: "pic.dokumentasi" },
    ],
  },
  ...
  // Tab-level (dalam halaman Adm Projek): finance.cashflow, finance.pr, finance.upload_dokumen, finance.surat_jalan, finance.tukang
  {
    ...
    items: [
      ...
      { label: "AR (Tagihan Outstanding)", href: "/finance/ar-outstanding",      icon: "AlertCircle",    permission: "finance.ar" },
  ...
  // ── RubahrumahxGolden ────────────────────────────────────────────────────────
  // Group: golden.view | Items: golden.meta_ads, golden.dashboard_ads, golden.follow_up, golden.kanban_admin, golden.kalender, golden.kalender_after, golden.kanban_sales
  {
