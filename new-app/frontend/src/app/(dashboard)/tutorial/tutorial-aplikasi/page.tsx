...
const ROLE_GUIDES: RoleSection[] = [
  ...
  {
    role: "Sales Admin Product dan Mitra",
    color: "#10b981",
    icon: PhoneCall,
    description: "Menangani leads RKR dan Golden untuk follow up, kanban, serta jadwal survey.",
    menus: [
      { name: "Kanban Admin Product", desc: "Pipeline leads RKR." },
      { name: "Kanban Golden", desc: "Pipeline leads Golden yang tersinkron dengan RubahrumahxGolden." },
      { name: "Follow Up Leads RKR / Golden", desc: "Reminder dan riwayat follow up per lead." },
      { name: "Kalender Survey RKR / Golden", desc: "Jadwal survey yang berhasil dibuat." },
      { name: "Laporan Harian", desc: "Input jumlah call, lead baru, dan konversi." },
    ],
    steps: [
      "Buka Kanban Admin Product atau Kanban Golden lalu ambil leads dari kolom yang sesuai.",
      "Setelah menghubungi, pindahkan lead ke kolom yang sesuai.",
      "Jika lead setuju survey, buat jadwal di Kalender Survey RKR atau Kalender Survey Golden.",
